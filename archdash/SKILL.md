...
```bash
cd /Users/kingyeazey/cloudability-multicloud-dashboard && npm run generate
```

Project location: `/Users/kingyeazey/cloudability-multicloud-dashboard/`
...
Service and chip classifications are defined in `src/classifications.mjs` and can be updated as new services or instance types are added.
